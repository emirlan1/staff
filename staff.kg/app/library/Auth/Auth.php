...
use Staff\Models\RememberTokens;
use Staff\Models\SuccessLogins;
use Staff\Models\FailedLogins;

/**
 * Staff\Auth\Auth
 * Manages Authentication/Identity Management in Staff
 */
class Auth extends Component
{
    ...
    public function check($credentials)
    {
        ...
        if (!$this->security->checkHash($credentials['password'], $user->password)) {
           // print_die($this->security->hash($credentials['password']));
            throw new Exception('Wrong email/password combination');
        }
